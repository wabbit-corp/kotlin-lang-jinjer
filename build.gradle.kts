...
mavenPublishing {
    ...
    signAllPublications()
    pom {
        name.set("kotlin-lang-jinjer")
        description.set("kotlin-lang-jinjer")
        url.set("https://github.com/wabbit-corp/kotlin-lang-jinjer")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-lang-jinjer")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-lang-jinjer.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-lang-jinjer.git")
        }
    }
}
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.lang.jinjer"
        compileSdk = 34
        minSdk = 26
    }
...
dokka {
    moduleName.set("kotlin-lang-jinjer")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-lang-jinjer/tree/master/src")
